...
DATA = {
    ...
    "irr_col": "Global_Solar_Flux",
    "target_col": "target_Global_Solar_Flux_15min",
    "image_size": 64,
    "sequence_length": 30,
    "cond_frames": 15,
    "future_frames": 15,
